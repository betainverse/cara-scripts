...
"""
shiftAllAmideProtons.py takes a CARA repository file and alters the
chemical shift of all amide proton spins by the amount specified with
...
### Parsing command-line options ##########################################
    ...
    parser.description = "%prog takes a cara repository file and shifts all the amide proton spins in a project by a specified amount. If the \'-a\' option is used, it also shifts aliases by the same amount."
    parser.epilog = ""
    parser.add_option("-s", "--shift", dest="shiftChange", type="float",
                      help="Desired change in chemical shift for all amide proton spins, required.")
