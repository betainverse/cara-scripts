...
"""
shiftAllAmideNitrogens.py takes a CARA repository file and alters the
chemical shift of all amide nitrogen spins by the amount specified with
...
### Parsing command-line options ##########################################
    ...
    parser.add_option("-s", "--shift", dest="shiftChange", type="float",
                      help="Desired change in chemical shift for all amide nitrogen spins, required.")
